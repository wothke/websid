...
element:"anyfunc"}):Array(b);a.wasmTable=c.table}c.memoryBase||(c.memoryBase=a.STATIC_BASE);c.tableBase||(c.tableBase=0);c=e(c);assert(c,"no binaryen method succeeded.");return c}})();var ma=[function(){console.log("info cannot be retrieved  from corrupt .mus file")},function(){console.log("FATAL ERROR: no free memory for driver")},function(){console.log("ERROR: PSID INIT hangs")},function(b){console.log("JAM 0:  $"+b.toString(16))}];L=1024;M=L+241072;ha.push({b:function(){na()}},{b:function(){ra()}});
a.STATIC_BASE=L;a.STATIC_BUMP=241072;M+=16;function sa(b){return Math.pow(2,b)}var ta=M;M=M+4+15&-16;R=ta;N=O=A(M);P=N+T;Q=A(P);K[R>>2]=Q;a.wasmTableSize=44;a.wasmMaxTableSize=44;a.c={};
